...
(:~~
 ...
 :)
declare variable $config:webcomponents :="2.24.5";
...
(:
 ...
 :)
declare variable $config:default-template :="skvr.html";
...
declare variable $config:facets := [
    ...
    map {
        "dimension": "part",
        "heading": "Osa",
        "source": "api/search/facets/part",        
        "hierarchical": false()
    },    
    map {
        "dimension": "number",
        "heading": "Numero",
        "source": "api/search/facets/number",     
        "max": 100,
        "hierarchical": false()
    },        
    map {
        "dimension": "collector",
        "heading": "Kerääjä",
        "source": "api/search/facets/collector",
        "hierarchical": false()
    },    
    map {
        "dimension": "collRegion",
        "heading": "Keräysalue (normalisoitu)",
        "source": "api/search/facets/collRegion",
        "hierarchical": false()
    },     
    map {
        "dimension": "collPlace",
        "heading": "Keräyspaikka (normalisoitu)",
        "source": "api/search/facets/collPlace",
        "hierarchical": false()
    },  
    map {
        "dimension": "dateSt",
        "heading": "Keräysaika",
        "source": "api/search/facets/dateSt",
        "hierarchical": false()
    }
];
...
declare variable $config:jr :=$config:data-root || "/jr";
declare variable $config:esipuheet :=$config:data-root || "/alkulauseet";
...
declare variable $config:data-exclude :=
    doc($config:data-root || "/taksonomiataulu.xml")/tei:TEI
;
