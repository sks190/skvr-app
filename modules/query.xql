...
(:~
 ...
 :)
declare function query:query-default($coll as xs:string*, $fields as xs:string+, $query as xs:string,
    $target-texts as xs:string*, $sortBy as xs:string*) {
    tei-query:query-default($coll, $fields, $query, $target-texts, $sortBy),
...
declare function query:query-metadata($path as xs:string, $field as xs:string, $query as xs:string, $sort as xs:string) {
    tei-query:query-metadata($path, $field, $query, $sort),
