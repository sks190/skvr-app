...
else if ($exist:path eq '/export-csv-search.xql') then
    <dispatch xmlns="http://exist.sourceforge.net/NS/exist">
        <forward url="{$exist:controller}/export-csv-search.xql"/>
    </dispatch>    
    
else if ($exist:path eq '/export-xml-search.xql') then
    <dispatch xmlns="http://exist.sourceforge.net/NS/exist">
        <forward url="{$exist:controller}/export-xml-search.xql"/>
    </dispatch>       
    
else if ($exist:path eq '/export-csv.xql') then
    <dispatch xmlns="http://exist.sourceforge.net/NS/exist">
        <forward url="{$exist:controller}/export-csv.xql"/>
    </dispatch>    
    
else if ($exist:path eq '/export-csv-jr.xql') then
    <dispatch xmlns="http://exist.sourceforge.net/NS/exist">
        <forward url="{$exist:controller}/export-csv-jr.xql"/>
    </dispatch>        
    
else if ($exist:path eq '/update.xql') then
    <dispatch xmlns="http://exist.sourceforge.net/NS/exist">
        <forward url="{$exist:controller}/update.xql"/>
    </dispatch> 
    
else if ($exist:path eq '/elias_loppuraportti_Lonnrotiana.pdf') then    
    <dispatch xmlns="http://exist.sourceforge.net/NS/exist">
        <forward url="{$exist:controller}/elias_loppuraportti_Lonnrotiana.pdf"/>
    </dispatch>    
    
else if ($exist:path eq '/Runotyyppi.pdf') then    
    <dispatch xmlns="http://exist.sourceforge.net/NS/exist">
        <forward url="{$exist:controller}/Runotyyppi.pdf"/>
    </dispatch>     
    
else if ($exist:path eq '/Fasetit-hakukentta.pdf') then    
    <dispatch xmlns="http://exist.sourceforge.net/NS/exist">
        <forward url="{$exist:controller}/Fasetit-hakukentta.pdf"/>
    </dispatch>   
    
else if ($exist:path eq '/Fasetit-valintaruutu.pdf') then    
    <dispatch xmlns="http://exist.sourceforge.net/NS/exist">
        <forward url="{$exist:controller}/Fasetit-valintaruutu.pdf"/>
    </dispatch>       
